...
Skabelon-notebok tassaavoq source-notebok aammalu inissisimaffiit soorlu
`{{settings.input_mode_help}}`. Locale-filit oqaatsinut immikkut ittunik pingaaruteqartunik tunniussisarput
Colab-imut tunngasunik assilisaq soorlu `# @title`, `# @markdown`, oqaaseqaatit, aamma toqqarneqarsimasut
atuisut nalunaarutaat. Lokalit tamarmik imaqartarput pladsholder-set-imik tamakkersimasumik
Tuluit killiffiat locale.

Notebookit pilersinneqarsimasut pisussaaffilerneqarput taamaalilluni Colab-linkit toqqissisimanarlutik.
...
`translate_full_locales.py` maskiina-mik tuluit oqaasiini tamakkerlugu nutserneqartarpoq
allat lokale-filerit kode-token-it soorlu `INPUT_MODE`,
`Google Drive`, `# @markdown`, aamma modelimik tunniussisut. Review nutserneqarsimasoq
pisortatigoortumik saqqummiussisoqarnissaa sioqqullugu.
...
CI-p suliassaqarfiani misissuinerit notebookit pilersinneqarsimasut ullumikkut atuuttut, annaaneqarsimanngillat
celle-t, parserlugit soorlu JSON, imaqanngillat inissisimaffiit aaqqinneqanngitsut, aammalu kode taanna
cellit tassaapput Python-imi syntaksi atuuttoq.

## Suna CI Misissuisinnaavaa

Una allagarsiivik allagarsiivimmi artefaktitut siammarterneqarsinnaasutut misilerarsinnaavaa:

- generation fraskabelonit aamma locale-fil-init
- allagartaq JSON atuuttoq
- empty exekuteringsoutput
- Pythonip syntaksi kode-celle-ni
- erseqqissumik ajunaarnersuaqarnermi isertugaat
- committed-imik pilersitsisimasut allagarsiiviit qalipaammut naleqquttut

Tamakkiisumik allattorsimaffimmi aqqut Colab-imut immikkut ittumik API-nik, modelinik annertuunik download-inik pisariaqartitsivoq,
GPU pissarsiarineqarsinnaaneq, aamma atuisunit tunniunneqartut mediafilerit. Taanna pineqartariaqarpoq a
manuelt imigassartorneq imaluunniit immikkut GPU/Colab-imik uppernarsaasiinermik suliassaq.

## Akuersissut

Una allagarsiiviup notebook-imik stillads-imik aamma sanaartornermut script-it allattorsimaffimmi saqqummersinneqarput
MIT Akuersissut. VibeVoice-ASR, modelip oqimaassusaa, aammalu pingajuusumik apeqqutaasut tassaapput
akuersissutiminnik namminneq aqunneqarlutik.
